...
import { Search, Filter, Plus, ArrowUpDown, ChevronDown, Trash2, Pencil } from "lucide-react";
...
//   };
  ...
  const customersData = [
    { id: "#CUST-001", name: "John Doe", email: "john@example.com", phone: "123-456-7890", status: "Active" },
    { id: "#CUST-002", name: "Jane Smith", email: "jane@example.com", phone: "987-654-3210", status: "Inactive" },
    { id: "#CUST-003", name: "Alice Johnson", email: "alice@example.com", phone: "555-555-5555", status: "Active" },
    { id: "#CUST-004", name: "Bob Brown", email: "bob@example.com", phone: "444-444-4444", status: "Active" },
    { id: "#CUST-005", name: "Charlie Black", email: "charlie@example.com", phone: "333-333-3333", status: "Inactive" },
];
      ...
      >
        ...
        <div className="flex justify-between items-center mb-6">
                    ...
                    <Card className="bg-white/5 border-white/10 shadow-lg">
                        <CardHeader>
                            <CardTitle className="text-white font-semibold text-2xl">Customer List</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                <TableHeader className="bg-white/5">
                                    <TableRow className="border-white/10 hover:bg-white/5">
                                        <TableHead className="text-white/70 text-md">Customer ID</TableHead>
                                    ...
                                    {sortedCustomers.length > 0 ? (
                                        sortedCustomers.map((customer, index) => (
                                            <TableRow key={index} className="border-white/10 hover:bg-white/5">
                                                <TableCell className="text-white/70 text-md">{customer.id}</TableCell>
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        <Avatar className="h-8 w-8">
                                                            <AvatarImage src="/placeholder.svg" alt="Customer Image" />
                                                            <AvatarFallback className="bg-purple-600">C</AvatarFallback>
                                                        </Avatar>
                                                        <span className="text-white/70 text-md">{customer.name}</span>
                                                    </div>
                                                </TableCell>
                                                <TableCell className="text-white/70 text-md">{customer.email}</TableCell>
                                                <TableCell className="text-white/70 text-md">{customer.phone}</TableCell>
                                                <TableCell>
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={6} className="text-center text-white/70">No customers found.</TableCell>
                                        </TableRow>
                                    )}
                                </TableBody>
                            </Table>
